...
/**
 * Update Redmine 02 project firstly
 * Oct 25, 20161:38:00 PM
 * @author tampt6722
 *
 */
class Redmine02UpdateProjectFirstly extends CommandRedmine02
{
    /**
     ...
     * @var string
     */
    protected $signature = '02_update_project_firstly:get {crawler_type}';
     ...
     * @var string
     */
    protected $description = 'Redmine 02 project updates info';
    ...
    private function saveProjectToCrawlerUrls($crawlerType, $projectId, $projectUpdate, $projectName){
        ...
        if (count($checkCrawlerUrl) == 0) {
            ...
            $crawlerUrl['content_type'] = "Project Terras";
