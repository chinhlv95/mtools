...
/**
 * Update Gdo projects firstly
 * Oct 28, 20162:09:22 PM
 * @author tampt6722
 *
 */
class GdoUpdateProjectFirstly extends CommandGDORedmine
{
    /**
     ...
     * @var string
     */
    protected $signature = 'gdo_update_project_firstly:get {crawler_type}';
    ...
    private function saveProjectToCrawlerUrls($crawlerType, $projectId, $projectUpdate, $projectName){
        ...
        if (count($checkCrawlerUrl) == 0) {
            ...
            $crawlerUrl['content_type'] = "Project GDO";
